 ...
 */
angular.module('ngPatternRestrict', []).directive('ngPatternRestrict', ['$log', function (a) {
    'use strict';
    return {
        restrict: 'A', require: '?ngModel', compile: function () {
            return function (a, b, c, d) {
                ...
                function g() {
                    var a, b, c, d = window.getSelection(), e = (d + '').length, f = !1;
